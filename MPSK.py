...
class MPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "M-PSK")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("M-PSK")
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad = tabla_de_verdad = [0.707+0.707j, -0.707+0.707j, 0.707-0.707j, -0.707-0.707j]
        self.M = M = len(tabla_de_verdad)
        ...
        labels = ['Señal en fase', 'Señal en cuadratura', 'Signal 3', 'Signal 4', 'Signal 5',
    ...
    def set_tabla_de_verdad(self, tabla_de_verdad):
        ...
        self.set_M(len(self.tabla_de_verdad))
